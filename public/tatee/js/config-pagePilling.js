        ...
        if(wW>1500){
            pagePillingWrap.each(function(){
                ...
                that.pagepiling({
                    ...
                    animateAnchor:false,
                    afterRender:function(){$('#pp-nav').addClass('pp-bullet');},
                    onLeave:function(index,nextIndex,direction){
                        ...
                        // Путь к изображению остается прежним независимо от значения color
                        header.find('.logo img').attr('src','http://127.0.0.1:8000/tatee/images/icon/logo-black.png');
                        if(nextIndex==4) jsLine.addClass('active');
                    }
                });
            });
